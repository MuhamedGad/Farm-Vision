    ...
    <Container className="overflow-hidden py-10 flex flex-col gap-32">
      ...
      <section className="flex items-center gap-24 md-lg:flex-col mx-auto">
        ...
        <div className="desc max-w-lg px-10 md-lg:px-0 md-lg:text-center ">
          ...
          <Button className="text-lg font-bold mt-32 md-lg:mt-16 px-10 py-2 !rounded-full text-emerald-600 border-4 border-emerald-600 hover:bg-emerald-400 hover:text-white hover:border-emerald-400">
            Watch Now
          </Button>
        </div>
      </section>
